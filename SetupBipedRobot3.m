...
uLINK(5) = struct('name','RLEG_J3' , 'm',  1, 'sister', 0, 'child', 6, 'b',[0  0  -0.4]' ,'a',UY,'q',0);
uLINK(6) = struct('name','RLEG_J4' , 'm',  6, 'sister', 0, 'child', 7, 'b',[0  0  -0.4]' ,'a',UY,'q',0);
...
uLINK(11)= struct('name','LLEG_J3' , 'm',  1, 'sister', 0, 'child',12, 'b',[0  0  -0.4]' ,'a',UY,'q',0);
uLINK(12)= struct('name','LLEG_J4' , 'm',  6, 'sister', 0, 'child',13, 'b',[0  0  -0.4]' ,'a',UY,'q',0);
...
qR2 = IK_leg(uLINK(BODY),-0.1,0.4,0.4,Rfoot);

% set left foot
Lfoot.p = [0,.1,0]';
Lfoot.R = RPY2R([0,0,0]);  %  -pi/4 < q < pi/4
qR3 = IK_leg(uLINK(BODY),0.1,0.4,0.4,Lfoot);
for n=0:5
