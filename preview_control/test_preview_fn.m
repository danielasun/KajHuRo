...
x0 = [0 0 0]';
y0 = [0 0 0]';
err0 = 0; % error in both systems to start out is zero

[qx,zmp_x,ux] = SimulatePreviewDynamics(sys,sys_t,Gi,Gx,Gd,pxref,x0,err0,N);
[qy,ysol,uy] = SimulatePreviewDynamics(sys,sys_t,Gi,Gx,Gd,pyref,y0,err0,N);
